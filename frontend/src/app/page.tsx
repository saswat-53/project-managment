...
const FeatureCard = ({
  ...
  <div className="group relative border border-stroke-dark bg-dark-secondary/40 p-7 transition-all duration-300 hover:border-amber-400/40 hover:bg-dark-secondary/80">
    ...
    <h3 className="mb-2 font-mono text-base font-semibold text-white">{title}</h3>
    <p className="font-mono text-sm leading-relaxed text-zinc-500">{desc}</p>
  </div>
);
      ...
      <div className="min-h-screen bg-dark-bg font-mono text-white">
        ...
        <nav className="anim-fade-in sticky top-0 z-50 flex items-center justify-between border-b border-stroke-dark/60 bg-dark-bg/90 px-6 py-4 backdrop-blur-md md:px-12">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/login"
              className="px-4 py-2 text-sm uppercase tracking-[0.15em] text-zinc-400 transition-colors hover:text-amber-400"
            >
              Sign In
            </Link>
            <Link
        ...
        <section className="relative flex min-h-[calc(100vh-57px)] flex-col items-start justify-center overflow-hidden px-6 py-24 md:px-12 lg:flex-row lg:items-center lg:gap-16 lg:px-20">
          ...
          <div className="relative z-10 flex-1 lg:max-w-[560px]">
            ...
            <h1 className="anim-fade-up delay-100 mb-7 text-5xl font-light leading-[1.08] tracking-tight text-white md:text-6xl lg:text-7xl">
              Ship work
              <br />
              that{" "}
            ...
            <p className="anim-fade-up delay-200 mb-10 max-w-md text-base leading-relaxed text-zinc-400">
            ...
            <div className="anim-fade-up delay-300 flex flex-wrap items-center gap-4">
              ...
              <Link
                href="/login"
                className="flex items-center gap-2 text-sm uppercase tracking-[0.15em] text-zinc-500 transition-colors hover:text-amber-400"
              >
                Sign in
            ...
            {[...Array(2)].map((_, pass) => (
              <div key={pass} className="flex items-center gap-0">
                {[
                  ...
                  <span
                    key={`${pass}-${item}`}
                    className="flex items-center gap-6 px-8 text-xs uppercase tracking-[0.25em] text-zinc-500"
                  >
        ...
        <section className="px-6 py-28 md:px-12 lg:px-20">
          <div className="mb-16">
            ...
            <h2 className="mt-6 text-4xl font-light leading-tight text-white md:text-5xl">
              ...
              <br />
              <span className="text-zinc-500">needs to execute.</span>
            </h2>
          </div>
