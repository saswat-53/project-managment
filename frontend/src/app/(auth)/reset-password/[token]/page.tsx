              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full border border-zinc-700 bg-zinc-800 px-4 py-3 pr-11 text-sm text-white placeholder-zinc-600 outline-none transition-all focus:border-amber-400"
                  />
                  <button
                    type="button"
